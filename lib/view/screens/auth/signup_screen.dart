...
import 'package:inditok/controller/auth_controller.dart';
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              ElevatedButton(
                  onPressed: () {
                    AuthController.instance.SignUp(_userController.text, _emailController.text, _setPasswordController.text, AuthController.instance.picimg);
                  },
                  child: const Padding(
